...
if __name__ == '__main__':
    ...
    DATA_DIR = './data'
    TRAIN_IMAGE_LIST = './data/train_pathology_patch_list.txt'
    VALID_IMAGE_LIST = './data/test_pathology_patch_list.txt'
#    VALID_IMAGE_LIST = './data/data_entry_test.txt'
#    HEATMAP_IMAGE_LIST = './data/data_entry_boxonly_test_.txt'
    SAVE_DIRS = 'ResNet50_pretrain_aug4_lr0.001_pathology_Class5'
    N_CLASSES = 5
    BATCH_SIZE = 64
    LR = 0.001
