# -*- coding: utf-8 -*-
"""
Created on Thu Dec 27 11:31:14 2018

@author: hls
info:
resnet50+MIL +lossfunction max pooling-based Multi-instance learning
two classification
fc3==2 classification
"""
...
class ResNet50(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.inplanes = 2048
        # two block
        self.layer5 = self._make_layer(Bottleneck, 64, 2, stride=1)
...
if __name__ == '__main__':
    ...
    SAVE_DIRS = 'ResNet50_pretrain_224aug_lr0.001_Class2_MIL_maxpoolingbased'
    N_CLASSES = 4
    BATCH_SIZE = 4
    LR = 0.0001  # * 0.1 * 0.1
